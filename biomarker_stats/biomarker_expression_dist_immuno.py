...
H5_PATH    = Path("/home/wesley/spatial_proteomics/immunoatlas_NOLN210920_patch_dataset.h5")
OUTPUT_DIR = Path("/home/wesley/spatial_proteomics/biomarker_stats/immunoatlas")
...
def main():
    ...
    hdr = (f"{'Idx':<4} {'Marker':<22} {'n_tokens':>12} {'mean':>8} {'std':>8} "
    ...
    for m_idx, marker in enumerate(marker_names):
        ...
        row = (f"{m_idx:<4} {marker:<22} {len(v):>12,} {v.mean():>8.4f} {v.std():>8.4f} "
    ...
    fig.suptitle(f"Token-level intensity distribution — immunoatlas NOLN210920\n"
